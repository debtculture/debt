...
const members = [
    { name: 'Autopsy', walletAddress: 'WALLET_ADDRESS_HERE', holderSince: '07/21/2024', xLink: 'https://x.com/AutopsyT2', img: 'https://res.cloudinary.com/dpvptjn4t/image/upload/f_auto,q_auto/v1758110923/rKUcuWaF_400x400_d3fqvc.jpg', badges: [{ type: 'spaces', tier: 'amethyst' }, { type: 'burn', tier: 'gold' }, { type: 'holding', tier: 'gold' }, { type: 'shiller', tier: 'single' }, { type: 'meme', tier: 'single' }] },
    { name: 'Catavina', walletAddress: 'WALLET_ADDRESS_HERE', holderSince: '11/17/2024', xLink: 'https://x.com/catavina17', img: 'https://res.cloudinary.com/dpvptjn4t/image/upload/f_auto,q_auto/v1746723030/catavina_dfcvoe.jpg', badges: [{ type: 'spaces', tier: 'amethyst' }, { type: 'holding', tier: 'gold' }, { type: 'shiller', tier: 'single' }, { type: 'meme', tier: 'single' }] },
    { name: 'Lou', walletAddress: 'WALLET_ADDRESS_HERE', holderSince: '01/10/2025', xLink: 'https://x.com/louisedbegin', img: 'https://res.cloudinary.com/dpvptjn4t/image/upload/f_auto,q_auto/v1752948926/Lou2_kxasor.jpg', badges: [{ type: 'spaces', tier: 'amethyst' }, { type: 'holding', tier: 'silver' }, { type: 'shiller', tier: 'single' }] },
    ...
    { name: 'Rankin', walletAddress: 'WALLET_ADDRESS_HERE', holderSince: '06/27/2025', xLink: 'https://x.com/rankin56696', img: 'https://res.cloudinary.com/dpvptjn4t/image/upload/f_auto,q_auto/v1758111531/rankin_mnn26k.jpg', badges: [{ type: 'holding', tier: 'bronze' }] },
