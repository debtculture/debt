...
const members = [
    { name: 'Autopsy', walletAddress: 'And9kryGbTyQppKPLfDrfbcpdBiygNXPoKX2MnymfFp1', holderSince: '07/21/2024', xLink: 'https://x.com/AutopsyT2', img: 'https://res.cloudinary.com/dpvptjn4t/image/upload/f_auto,q_auto/v1758110923/rKUcuWaF_400x400_d3fqvc.jpg', badges: [{ type: 'spaces', tier: 'amethyst' }, { type: 'burn', tier: 'gold' }, { type: 'holding', tier: 'gold' }, { type: 'shiller', tier: 'single' }, { type: 'meme', tier: 'single' }] },
