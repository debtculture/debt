...
function renderProfileView(posts) {
    ...
    let socialsHtml = '';
    if (currentUserProfile.twitter_handle) { socialsHtml += `<a href="https://x.com/${currentUserProfile.twitter_handle}" target="_blank" rel="noopener noreferrer" title="X / Twitter"><img src="https://res.cloudinary.com/dpvptjn4t/image/upload/f_auto,q_auto/v1746723033/X_olwxar.png" alt="X" style="width: 40px; height: 40px;"></a>`; }
    if (currentUserProfile.telegram_handle) { socialsHtml += `<a href="https://t.me/${currentUserProfile.telegram_handle}" target="_blank" rel="noopener noreferrer" title="Telegram"><img src="https://res.cloudinary.com/dpvptjn4t/image/upload/f_auto,q_auto/v1746723031/Telegram_mvvdgw.png" alt="Telegram" style="width: 40px; height: 40px;"></a>`; }
    if (currentUserProfile.discord_handle) { socialsHtml += `<a href="#" onclick="alert('Discord: ${currentUserProfile.discord_handle}'); return false;" title="Discord"><img src="https://res.cloudinary.com/dpvptjn4t/image/upload/f_auto,q_auto/v1750977177/Discord_fa0sy9.png" alt="Discord" style="width: 40px; height: 40px;"></a>`; }
    if (currentUserProfile.youtube_url) { socialsHtml += `<a href="${currentUserProfile.youtube_url}" target="_blank" rel="noopener noreferrer" title="YouTube"><img src="https://res.cloudinary.com/dpvptjn4t/image/upload/f_auto,q_auto/v1758747358/YouTube_PNG_jt7lcg.png" alt="YouTube" style="width: 40px; height: 40px;"></a>`; }
    if (currentUserProfile.magiceden_url) { socialsHtml += `<a href="${currentUserProfile.magiceden_url}" target="_blank" rel="noopener noreferrer" title="Magic Eden"><img src="https://res.cloudinary.com/dpvptjn4t/image/upload/f_auto,q_auto/v1762140417/Magic_Eden_gl926b.png" alt="Magic Eden" style="width: 40px; height: 40px;"></a>`; }
